...
## Contents
### 15% test data
This folder contains the data sets with training and 15% testing data pre-separated(data_matrix_list_15%.RData) and all assignments (asgn_1~4_15%.RData) of each algorithm when the maximum accuracy is reached. Folder of 20% and 25% contain similar files.
